...
GameBoard.prototype.drawThings = function () {
  const forms = {
    ...
    'walls': {
      'wall01':   '<rect x="2" y="2" width="2" height="2" id="wall01_01" class="form wall wall01 wall01_01"/>\
                  <rect x="4" y="2" width="2" height="2" id="wall01_02" class="form wall wall01 wall01_02"/>\
                  <rect x="2" y="4" width="2" height="2" id="wall01_03" class="form wall wall01 wall01_03"/>\
                  <rect x="4" y="4" width="2" height="2" id="wall01_04" class="form wall wall01 wall01_04"/>',
